...
/*global require, define, brackets: true, $, window, document, navigator,Backbone, jQuery, html2canvas, InstallTrigger */

/**************
 *   @author : Rithwik Anand
 *   @desc : DnDBox - DnDBox provides an easy to consume Draggable Carousel.
...
(function (un) {
    ...
    var isOpera, isFirefox, isSafari, isChrome, isIE, isTouchDevice;
    ...
    DnDBox.prototype = {
        ...
        swapBlocks : function (fromIndex, toIndex) {
            ...
            if ((fromBlock.getAttribute('drag-state') !== "true" && fromBlock.getAttribute('drop-state') !== "true") ||
                    (toBlock.getAttribute('drag-state') !== "true" && toBlock.getAttribute('drop-state') !== "true")) {
                return false;
            }
        ...
        _getBlockStyles : function () {
            ...
            var sStyle = ["height : ", this.styles.blockHeight,
                          ";width : ", this.styles.blockWidth,
                          ";margin : ", this.styles.blockMargin, " ", this.styles.horizontalBlockMargin,
                          ";position : absolute"
                        ].join("");
            return sStyle;
        },
        ...
        _getSeparatorStyles : function () {
            var sStyle = ["height : ", this.styles.separatorHeight,
                          ";width : 100%",
                          ";position : absolute"
                         ].join("");
            return sStyle;
        ...
        _getRemoveIconStyles : function () {
            var sStyle = ["height : ", this.styles.removeIconHeight,
                          ";width : ", this.styles.removeIconHeight,
                          ";float : right",
        ...
        _onDragStart : function (e, ctx, blockWrapper) {
            ...
            var containerEle = ctx.eleRefs.containerEle;
